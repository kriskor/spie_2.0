...
<head>
    ...
    <title>SPIE - Modulo de Indicadores</title>
    <!-- Bootstrap Core CSS -->
    <link href="/assets_admin_two/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <!-- animation CSS -->
    <link href="/assets_admin_two/css/animate.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="/assets_admin_two/css/style.css" rel="stylesheet">
    <!-- color CSS you can use different color css from css/colors folder -->
    <link href="/assets_admin_two/css/colors/megna.css" id="theme" rel="stylesheet">

    <link id="theme" href="/assets_admin_two/css/colors/megna.css" rel="stylesheet">
...
<body class="fix-header">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part">
                  <a class="logo" href="{{url ('/planificacion/dashboard') }}"><b><img src="" alt="-O-" />
                  </b><span class="hidden-xs"> <img src="" alt="" /> INDICADORES</span>
                  </a>
                </div>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <!-- Menu para envio de Mensajes o notificaciones al usuario -->
                    <!--
                    <li class="dropdown">
                    ...
                    -->
                    <!-- Menu para envio de tareas al usuario
                    <li class="dropdown">
                  ...
                  <!-- Megamenu *- Menu para links o accesos rapidos
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a id="mp_inicio" href="{{ url('/indicadores/dashboard') }}" class="waves-effect"><i data-icon="v" class="linea-icon linea-basic fa-fw" ></i>
    ...
    <script src="/assets_admin_two/bootstrap/dist/js/tether.min.js"></script>
    <script src="/assets_admin_two/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="/plugins/bower_components/bootstrap-extension/js/bootstrap-extension.min.js"></script>
    <!-- Menu Plugin JavaScript -->
    <script src="/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js"></script>
    <!--slimscroll JavaScript -->
    <script src="/assets_admin_two/js/jquery.slimscroll.js"></script>
    <!--Wave Effects -->
    <script src="/assets_admin_two/js/waves.js"></script>
    <!-- Custom Theme JavaScript -->
    <script src="/assets_admin_two/js/custom.min.js"></script>
    <script src="/assets_admin_two/js/validator.js"></script>
    <!--Style Switcher -->
