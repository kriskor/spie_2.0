...
@section('content')
  <div class="row bg-title p-t-0 p-b-0 m-b-5">
      <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h5 class="page-title">Entidades Por Metas</h5>
      </div>
...
<div class="row">
    ...
    <div class="col-lg-6 col-md-12 ">
        <div class="white-box p-10">
            <h3 class="box-title">Total Entidades por Metas</h3>
    ...
    <div class="col-lg-6 col-md-12 ">
        <div class="white-box p-10">
            <h3 class="box-title">Metas / Entidades </h3>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      var source =
      {
          ...
          id: '',
          url: "{{ url('/modulopdes/ajax/listametasentidades') }}"
      };
      ...
      $("#jqxgrid").jqxGrid(
        {
            ...
            columns: [
              { text: 'Codigo', datafield: 'codigo', width: 55},
        ...
        $.ajax({
                url: "{{url("/modulopdes/ajax/totalmetasentidades")}}",
        ...
        function GRaficarDatos(ele){
          ...
          "valueAxes": [ {
            "title": "Nº de Entidades por meta",
            "gridColor": "#FFFFFF",
            "gridAlpha": 0.2,
            "dashLength": 0
          } ],
