...
@section('content')
  <div class="row bg-title p-t-0 p-b-0 m-b-5">
      <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h5 class="page-title">Entidades Por Pilares</h5>
      </div>
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
          <ol class="breadcrumb">
              <li><a href="#">Entidad</a></li>
              <li class="active">Pilares</li>
          </ol>
      </div>
      <!-- /.col-lg-12 -->
</div>
<div class="row">
    ...
    <div class="col-lg-6 col-md-12 ">
        <div class="white-box p-10">
            <h3 class="box-title">Total Entidades por Pilar</h3>
    ...
    <div class="col-lg-6 col-md-12 ">
        <div class="white-box p-10">
            <h3 class="box-title">Pilares / Entidades </h3>
    ...
    $(document).ready(function(){
      ...
      var source =
      {
          ...
          dataFields: [
            ...
            { name: 'sigla_p',type: 'string' },
            { name: 'nombre', type: 'string' }
          ],
          id: '',
          url: "{{ url('/modulopdes/ajax/listapilaresentidades') }}"
      };
      ...
      $("#jqxgrid").jqxGrid(
        {
            ...
            columns: [
              { text: 'Codigo', datafield: 'sigla_p', width: 50},
        ...
        $.ajax({
                url: "{{url("/modulopdes/ajax/totalpilaresentidades")}}",
        ...
        function GRaficarDatos(ele){
          ...
          "valueAxes": [ {
            "title": "Nº de Entidades por pilar",
            "gridColor": "#FFFFFF",
            "gridAlpha": 0.2,
            "dashLength": 0
          } ],
